...
import {faBoxesAlt, faDoorOpen, faPercent, faPerson} from "@fortawesome/free-solid-svg-icons";
...
export const Navbar = () => {
    ...
    return (
        <div className={css.navbar}>
            ...
            <CheckPermission permission={'admin.access'} returnable={
                <NavItem key={'User'}
                         to={'/admin'}
                         selected={toBool(location, '/admin')}
                         text={'Администратор'} fa={faPerson}/>
            }/>
            <CheckPermission permission={'admin.access'} returnable={
                <NavItem key={'Exit'}
                         to={'/logout'}
